package cn.zx.website.algorithms.strings;
...
public class StringFunctions {
	...
	public static final String reverseWithStringBuilderBuiltinMethod(
			String string) {
	...
	public static final String reverseWordsByCharWithAdditionalStorage(
			String string) {
		StringBuilder builder = new StringBuilder();
	...
	public static final String reverseWordsUsingStringTokenizerWithAdditionalStorage(
			String string) {
		String output = new String();
	...
	public static final String reverseWordsUsingSplitWithAdditionalStorage(
			String string) {
		StringBuilder builder = new StringBuilder();
	...
	private static final void swapWords(int startA, int endA, int startB,
			int endB, char[] array) {
	...
	public static final int levenshteinDistance(String s, String t) {
		...
		if (sLength == 0)
			...
			int min3 = levenshteinDistance(s.substring(1), t.substring(1))
					+ cost;
