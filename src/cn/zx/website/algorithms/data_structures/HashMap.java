...
public class HashMap<K extends Number, V> implements IMap<K, V> {
	...
	private static class JavaCompatibleIteratorWrapper<K extends Number, V>
		...
		public JavaCompatibleIteratorWrapper(HashMap<K, V> map,
	...
	private static class JavaCompatibleMapEntry<K extends Number, V> extends
	...
	private static class JavaCompatibleHashMap<K extends Number, V> extends
