...
public interface List<T> extends IList<T> {
	...
	public static class JavaCompatibleArrayList<T> extends
			java.util.AbstractList<T> implements java.util.RandomAccess {
	...
	public static class JavaCompatibleLinkedList<T> extends
		...
		private static class LinkedListListIterator<T> implements
