package cn.zx.website.algorithms.sequence;
...
public class FibonacciSequence {
	...
	public static final long fibonacciSequenceUsingRecursion(int n) {
		if (n == 0 || n == 1)
			...
			return fibonacciSequenceUsingRecursion(n - 1)
					+ fibonacciSequenceUsingRecursion(n - 2);
	}
	...
	public static final long fibonacciSequenceUsingBinetsFormula(int n) {
		return (long) Math.floor(Math.pow(PHI, n) * INVERSE_SQUARE_ROOT_OF_5
				+ 0.5);
	}
}
