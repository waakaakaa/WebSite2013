...
public class QuickSort<T extends Comparable<T>> {
	...
	public static <T extends Comparable<T>> T[] sort(PIVOT_TYPE type,
			T[] unsorted) {
	...
	private static <T extends Comparable<T>> void sort(int pivotIndex,
			int start, int finish, T[] unsorted) {
